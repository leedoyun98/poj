...
<head>
    ...
    <!--[if lt IE 9]>
        <script src="<%=application.getContextPath()%>/assets/mgr/js/html5shiv.js"></script>
        <script src="<%=application.getContextPath()%>/assets/mgr/js/respond.min.js"></script>
    <![endif]-->       
    <link rel="shortcut icon" href="<%=application.getContextPath()%>/assets/mgr/imagers/ico/favicon.ico">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="<%=application.getContextPath()%>/assets/mgr/imagers/ico/apple-touch-icon-144-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="114x114" href="<%=application.getContextPath()%>/assets/mgr/imagers/ico/apple-touch-icon-114-precomposed.png">
    <link rel="apple-touch-icon-precomposed" sizes="72x72" href="<%=application.getContextPath()%>/assets/mgr/imagers/ico/apple-touch-icon-72-precomposed.png">
    <link rel="apple-touch-icon-precomposed" href="<%=application.getContextPath()%>/assets/mgr/imagers/ico/apple-touch-icon-57-precomposed.png">
    <style>
...
<body>
    <div class="logo-image">                                
       <a id="home" href="#"><img class="img-responsive" src="<%=application.getContextPath()%>/assets/mgr/imagers/logo.png" alt=""> </a> 
    </div>
