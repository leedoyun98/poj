...
<head>
    ...
    <!--[if lt IE 9]>
        <script src="<%=application.getContextPath()%>/assets/tea/js/html5shiv.js"></script>
        <script src="<%=application.getContextPath()%>/assets/tea/js/respond.min.js"></script>
    <![endif]-->       
...
<body>
    ...
    <script type="text/javascript" src="<%=application.getContextPath()%>/assets/tea/js/jquery.js"></script>
    <script type="text/javascript" src="<%=application.getContextPath()%>/assets/tea/js/bootstrap.min.js"></script>
    <script type="text/javascript" src="<%=application.getContextPath()%>/assets/tea/js/wow.min.js"></script>
    <script type="text/javascript" src="<%=application.getContextPath()%>/assets/tea/js/coundown-timer.js"></script>
    <script type="text/javascript" src="<%=application.getContextPath()%>/assets/tea/js/main.js"></script>
    <script>
